...
{
    public partial class ECodeWorldV2Context : DbContext
    {
        public ECodeWorldV2Context()
        {
        }

        public ECodeWorldV2Context(DbContextOptions<ECodeWorldV2Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=HKHDCDEVSQL01;Database=ECodeWorldV2;Trusted_Connection=True;");
            }
        }
