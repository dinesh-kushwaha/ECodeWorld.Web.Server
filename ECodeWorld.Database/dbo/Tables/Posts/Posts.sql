...
(
	...
	[PostTypesID] [int] CONSTRAINT FK_PostsPostTypes FOREIGN KEY REFERENCES PostsTypes(ID),
	...
	[CategoryID] [int] CONSTRAINT FK_PostsPostCategories FOREIGN KEY REFERENCES PostsCategories(ID),
	[Contents] [nvarchar](max) NULL,
	[Status] [int] NOT NULL DEFAULT 0,
	[LikeCounts] [int] NOT NULL DEFAULT 0,
	[CommentCounts] [int] NOT NULL DEFAULT 0,
	[PostStatusID] [int] CONSTRAINT FK_PostsPostStatus FOREIGN KEY REFERENCES PostsStatus(ID),
